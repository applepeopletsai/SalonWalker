...
class RangeSlider: UIControl {
  ...
  @IBInspectable var maximumValue: Double = 10.0 {
    didSet {
      updateTrackLayerFrameAndKnobPositions()
    }
  }
  ...
  @IBInspectable var minimumDistance: Double = 0.0 {
    didSet {
      updateTrackLayerFrameAndKnobPositions()
    }
  }
  ...
  @IBInspectable var lowerValue: Double = 2.0 {
    didSet {
      updateTrackLayerFrameAndKnobPositions()
    }
  }
  ...
  @IBInspectable var upperValue: Double = 8.0 {
    didSet {
      updateTrackLayerFrameAndKnobPositions()
    }
  }
  ...
  @IBInspectable var stepValue: Double = 0.0 {
    didSet {
      updateTrackLayerFrameAndKnobPositions()
    }
  }
  ...
  @IBInspectable var trackThickness: CGFloat = 0.05 {
    didSet {
      updateTrackLayerFrameAndKnobPositions()
    }
  }
  ...
  @IBInspectable var trueTrackThickness: Bool = false {
    didSet {
      updateTrackLayerFrameAndKnobPositions()
    }
  }
  ...
  @IBInspectable var dragTrack: Bool = false
  
  ///The diameter of the Knob. '0.95' by default.
  @IBInspectable var knobSize: CGFloat = 0.95 {
    didSet {
  ...
  @IBInspectable var trueKnobSize: Bool = false {
    didSet {
      updateLayerFramesAndPositions()
      lowerKnob.setNeedsDisplay()
      upperKnob.setNeedsDisplay()
  ...
  @IBInspectable var knobTintColor: UIColor = UIColor.white {
    didSet {
      lowerKnob.setNeedsDisplay()
      upperKnob.setNeedsDisplay()
    }
  ...
  @IBInspectable var knobBorderThickness: CGFloat = 0.1 {
    didSet {
      lowerKnob.setNeedsDisplay()
      upperKnob.setNeedsDisplay()
    }
  ...
  @IBInspectable var knobBorderTintColor: UIColor = UIColor.gray {
    didSet {
      lowerKnob.setNeedsDisplay()
  ...
  @IBInspectable var selectedKnobDiameterMultiplier: CGFloat = 1.0 {
    didSet {
      lowerKnob.setNeedsDisplay()
      upperKnob.setNeedsLayout()
    }
  ...
  @IBInspectable var knobHasShadow: Bool = true {
    didSet{
      lowerKnob.setNeedsDisplay()
      upperKnob.setNeedsDisplay()
    }
  ...
  required public init(coder: NSCoder) {
    ...
    open override func layoutSubviews() {
        self.updateLayerFramesAndPositions()
    }
  ...
  func updateLayerFramesAndPositions() {
    lowerKnob.frame = CGRect(x: 0, y: 0, width: KnobSize, height: KnobSize)
    upperKnob.frame = CGRect(x: 0, y: 0, width: KnobSize, height: KnobSize)
    updateTrackLayerFrameAndKnobPositions()
  }
  ...
  func updateTrackLayerFrameAndKnobPositions() {
    CATransaction.begin()
     ...
     */
    func getLabelText(forValue value: Double) -> String {
