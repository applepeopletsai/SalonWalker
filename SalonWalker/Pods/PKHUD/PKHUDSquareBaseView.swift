...
//    static let defaultSquareBaseViewFrame = CGRect(origin: CGPoint.zero, size: CGSize(width: 156.0, height: 156.0))
    static let defaultSquareBaseViewFrame = CGRect(origin: CGPoint.zero, size: CGSize(width: 120.0, height: 120.0))
...
//        let threeQuarterHeight = CGFloat(ceilf(CFloat(viewHeight / 4.0 * 3.0)))
        let sixHeight = CGFloat(ceilf(CFloat(viewHeight / 6.0)))
...
//        imageView.frame = CGRect(origin: CGPoint(x:0.0, y:quarterHeight), size: CGSize(width: viewWidth, height: halfHeight))
        imageView.frame = CGRect(origin: CGPoint(x:0.0, y:sixHeight), size: CGSize(width: viewWidth, height: halfHeight))
        subtitleLabel.frame = CGRect(origin: CGPoint(x:0.0, y:sixHeight + halfHeight), size: CGSize(width: viewWidth, height: viewHeight - sixHeight - halfHeight))
    }
}
