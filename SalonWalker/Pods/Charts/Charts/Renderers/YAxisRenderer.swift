...
open class YAxisRenderer: AxisRendererBase
{
    ...
    open override func renderGridLines(context: CGContext)
    {
        ...
        if yAxis.drawGridLinesEnabled
        {
            ...
            {
                if i % 4 == 0 {
                    context.setStrokeColor(UIColor(red: 0.78, green: 0.78, blue: 0.78, alpha: 1.0).cgColor)
                } else {
                    context.setStrokeColor(UIColor(red: 0.78, green: 0.78, blue: 0.78, alpha: 0.4).cgColor)
                }
